...
class OrderItemViewSet(PermissionRequiredMixin, viewsets.ModelViewSet):
...
class PostOrderViewSet(PermissionRequiredMixin, viewsets.ModelViewSet):
    queryset = Order.objects.all()
    serializer_class = OrderSerializer
    #pagination_class = CustomPagination
...
class PutOrderViewSet(PermissionRequiredMixin, viewsets.ModelViewSet):
    queryset = Order.objects.all()
    serializer_class = OrderSerializer
    #pagination_class = CustomPagination
...
class DeleteOrderViewSet(PermissionRequiredMixin, viewsets.ModelViewSet):
    queryset = Order.objects.all()
    serializer_class = OrderSerializer
    #pagination_class = CustomPagination
