...
from product.views import GetProductViewSet, PostProductViewSet, PutProductViewSet, DeleteProductViewSet
from .views import  *
from role.views import RoleViewSet
from orders.views import OrderItemViewSet, ExportAPIView, ChartAPIView, PostOrderViewSet, GetOrderViewSet, PutOrderViewSet, DeleteOrderViewSet
